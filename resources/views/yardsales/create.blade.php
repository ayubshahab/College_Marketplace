                ...
                <div class = "listingFormContainer yard-sale-cont">
                    ...
                    enctype="multipart/form-data">
                        ...
                        <section class="listingCard">
                            ...
                            <input type="text" name = "yard_sale_title" placeholder="Yard Sale Title"  value="{{ old('yard_sale_title', null) }}" />
                            @error('yard_sale_title')
                                {{$message}}
                            @enderror
                            ...
                            name='yard_sale_date' 
                            placeholder="Yard Sale Date" value="{{old('yard_sale_date',null)}}"/>
                            @error('yard_sale_date')
                                {{$message}}
                            @enderror
                            ...
                            <div class="time-input">
                                <div class="start-time">
                                    ...
                                    <input type="time" id="start_time" name="start_time" value="{{old('start_time',null)}}">
                                    @error('start_date')
                                        {{$message}}
                                    @enderror
                                </div>
                                <div clas="end-time">
                                    ...
                                    <input type="time" id="end_time" name="end_time" value="{{old('end_time',null)}}">
                                    @error('end_time')
                                        {{$message}}
                                    @enderror
                                </div>
                            ...
                            {{-- description --}}
                            {{-- <textarea name="description" placeholder="Description" rows="8" style="resize: none;">{{ old('description', null) }}</textarea>
                            @error('description')
                                <p>{{$message}}</p>
                            @enderror --}}
                        </section>
