...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="condition-box">
                                <select name="negotiable" id="">
                                     <option value="Fixed"<?php echo e($listing->negotiable == 'Fixed' ? "selected":""); ?>>Fixed</option>
                                    
                                    <option value="Negotiable" <?php echo e($listing->negotiable == 'Negotiable' ? "selected":""); ?>

                                        >Negotiable/ OBO (best offer)</option>

                                    <option value="Free" <?php echo e($listing->negotiable == 'Free' ? "selected":""); ?>>Free</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class = "listingCard">
                            ...
                            <input type="text" id = "street" name="street" placeholder="Enter a Location*"  value="<?php echo e($listing->street); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                            <input type="text" id = "apartment_floor" name="apartment_floor" placeholder="Apartment, unit, suite, or floor #"  value="<?php echo e($listing->apartment_floor); ?>"/>
                            <input type="text" id = "city" name = "city" placeholder="City*"  value="<?php echo e($listing->city); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                            <input type="text" id = "state" name = "state" placeholder="State*"  value="<?php echo e($listing->state); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                            <input type="text" id = "country" name = "country" placeholder="Country*"  value="<?php echo e($listing->country); ?>" />
...
unset($__errorArgs, $__bag); ?>
                            <input type="text" id = "postcode" name = "postcode"placeholder="Postcode*"  value="<?php echo e($listing->postcode); ?>" />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input type="hidden" name="latitude" id ="latitude" value = "<?php echo e($listing->latitude); ?>">
                            <input type="hidden" name="longitude" id = "longitude" value = "<?php echo e($listing->longitude); ?>">

                            <p class="create-listing-header">Use My Location:</p>
                            <h6 onclick="getLocation()" class = "preview" id="location" style="font-size:1em;">
                                <?php if($listing->latitude != null and $listing->longitude != null): ?>
                                    Latitude: <?php echo e($listing->latitude); ?> Longitude: <?php echo e($listing->longitude); ?>
